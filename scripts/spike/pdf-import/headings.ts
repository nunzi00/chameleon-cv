/**
 * Títulos de sección de un CV en español e inglés (T-8.4, P1): un diccionario cerrado con variantes; una línea es
 * título si, normalizada (sin numeración, dos puntos ni espaciado entre letras), coincide con una entrada.
 */
