// Tema «terracotta» de Chameleon CV (T-8.16, estilo): acento cálido de tierra cocida en el nombre, los títulos y las viñetas, sobre un gris cálido: cercano sin perder formalidad.
...
// Para personalizar: `cv theme create mio --from terracotta` y edita theme.toml o template.typ (contrato en
