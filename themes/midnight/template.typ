// Tema «midnight» de Chameleon CV (T-8.16, estilo): azules profundos sobre papel claro, con el nombre y los títulos en azul noche y las secciones subrayadas por un filete grueso: pensado para leerse en pantalla.
...
// Para personalizar: `cv theme create mio --from midnight` y edita theme.toml o template.typ (contrato en
...
#let section(s, title) = block(
  ...
  sticky: true,
  inset: (bottom: 3pt),
  stroke: (bottom: 1.6pt + s.primary),
  text(font: s.fonts.heading, size: s.sizes.section, weight: "bold", fill: s.primary, tracking: 0.08em, upper(title)),
)
