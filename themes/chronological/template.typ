// Tema «chronological» de Chameleon CV (T-8.12, organización): cronología inversa con la fecha como eje. El periodo
// va en una columna fija a la izquierda de cada entrada (experiencia, formación y certificaciones) y el contenido a la
// derecha; los proyectos llevan su periodo bajo el título. Después, habilidades, logros e idiomas. Es la organización
// de siempre hecha explícita: la que esperan la mayoría de los procesos de selección.
...
// Para personalizar: `cv theme create mio --from chronological` y edita theme.toml o template.typ (contrato en
