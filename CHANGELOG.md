...
- **Las fechas escritas letra a letra vuelven a reconocerse** (B-10, parcial): algunas plantillas espacian el texto («2 0 1 1 - 2 0 1 3», «S E P T I E M B R E 2 0 1 7 - P R E S E N T E») y así ninguna entrada abría. Ahora se recompone lo que se puede recomponer **sin inventar**: las cifras y el salto de letra a cifra. Un título espaciado sin cifras se deja como está a propósito, porque la frontera entre palabras se pierde dentro de pdf.js y «D E S A R R O L L A D O R  W E B» sin ella sería «DESARROLLADORWEB».
- **Un título de sección espaciado partido en dos líneas ya no cierra su propia sección** (B-10, parcial): «E D U C A C I Ó N» seguido de «P R E V I A» hacía que la segunda línea se tomara por una cabecera desconocida —regla que existe para que el contenido ajeno no se cuele— y vaciaba la sección recién abierta. Ahora la segunda línea espaciada se entiende como la cola del título.
