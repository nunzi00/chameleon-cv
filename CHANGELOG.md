...
- Dos temas Typst nuevos en la galería: `awesome` (estilo Awesome-CV: nombre en dos pesos, titular en versalitas de color, secciones con las tres primeras letras en acento, rejilla 2×2) y `executive` (banking: logros destacados arriba, fila de competencias clave, impacto en negrita); una columna, sin iconos ni barras, sin fuentes nuevas (T-8.7).
