...
```bash
docker run --rm -v "$PWD/my-profile:/work" ghcr.io/nunzi00/chameleon-cv:1.6.0 --help   # sin clonar nada
...
npm run release:notes -- 1.6.0                            # notas de la release de esa versión, extraídas de CHANGELOG.md (las usa el flujo de release)
```
