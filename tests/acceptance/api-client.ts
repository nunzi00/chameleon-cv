...
const CALLS: readonly Call[] = [
  ...
  { method: 'GET', path: '/export', render: summarizeProfile },
  { method: 'POST', path: '/import', body: { profile: { personal: { fullName: 'Perfil Importado' } } } },
  { method: 'POST', path: '/import', body: { profile: { personal: { fullName: '' }, experience: [{ id: 'X' }] } } },
  { method: 'POST', path: '/import', body: { profile: 'no' } },
  { method: 'GET', path: '/config/llm' },
  { method: 'PUT', path: '/config/llm', body: { provider: 'ollama' } },
  { method: 'PUT', path: '/config/llm', body: { provider: 'openai' }, headers: { 'If-Match': '"61724d1017fa00d7f26722a45a422b1bacea48d002d5abbdb756a5975fc567dc"' } },
  { method: 'PUT', path: '/config/llm', body: { provider: 'openai-compatible', model: 'qwen', models: { groq: 'openai/gpt-oss-20b' } }, headers: { 'If-Match': '"61724d1017fa00d7f26722a45a422b1bacea48d002d5abbdb756a5975fc567dc"' } },
  { method: 'GET', path: '/config/llm' },
  { method: 'POST', path: '/config/llm/check', body: {} },
  { method: 'POST', path: '/config/llm/check', body: { provider: 'groq' } },
  ...
  { method: 'POST', path: '/themes/install', body: { source: 'themes/comunidad.zip', dryRun: true } },
  { method: 'POST', path: '/themes/install', body: { source: 'themes/comunidad.zip' } },
  { method: 'POST', path: '/themes/install', body: { source: 'themes/comunidad.zip' } },
  { method: 'POST', path: '/themes/comunidad/verify' },
  { method: 'POST', path: '/themes/classic/verify' },
  { method: 'POST', path: '/themes/install', body: { source: 'themes/escapa.zip' } },
  { method: 'POST', path: '/themes/install', body: { source: 'https://ejemplo.org/tema.zip' } },
  { method: 'GET', path: '/themes' },
  { method: 'GET', path: '/jobs' },
  { method: 'POST', path: '/jobs/improve', body: {} },
  { method: 'POST', path: '/jobs/suggest-tags', body: { text: 'Migré la plataforma de pagos a Kubernetes' } },
  { method: 'GET', path: '/jobs/nope' },
  { method: 'DELETE', path: '/jobs/nope' },
  { method: 'GET', path: '/reviews' },
  { method: 'GET', path: '/reviews/revision-nada.md' },
  { method: 'GET', path: '/reviews/otro.md' },
  { method: 'PUT', path: '/reviews/revision-x.md', body: { content: 'x' } },
  { method: 'POST', path: '/reviews/otro.md/apply', body: {} },
