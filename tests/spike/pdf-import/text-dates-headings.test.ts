...
import { detectHeading, headingKey, skillCategory } from '../../../scripts/spike/pdf-import/headings';
import { alphanumeric, contains, normalize, similarity } from '../../../scripts/spike/pdf-import/text';
