/**
 * Procedencia de los ítems del co-piloto en las fuentes (T-4.7): al generar una revisión, `improve` y
 * `summarize` anotan en cada ítem el fichero, la línea y la huella del original en `data/sources`, para que
 * `apply` sepa dónde escribir y pueda negarse si algo cambió.
 */
...
export async function indexSources(context: Pick<AppContext, 'datasetFileSystem' | 'parsers'>, datasetDir: string): Promise<SourceIndexResult> {
