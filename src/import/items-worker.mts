/**
 * Worker de items (T-8.4b, docs/cv-import.md §2): el mismo pdf.js endurecido que `src/pdf/worker.mts` —sin fuentes,
 * sin render, sin red— pero devuelve los *items* de texto con coordenadas y tamaño de fuente en lugar de líneas.
 */
import { parentPort, workerData } from 'node:worker_threads';

import '../pdf/polyfills.mts';
