/**
 * Utilidades de texto de la importación de CV (T-8.4b, docs/cv-import.md §2): normalización sin acentos ni signos y
 * una similitud de Dice sobre bigramas de caracteres (robusta a guiones de partición, espacios y mayúsculas).
 * Origen: el spike T-8.4 (P1/P3), medido en docs/pdf-import-spike.md.
 */
