...
function fakeApi(overrides: Partial<ApiClient> = {}): ApiClient {
  return {
    ...
    cancelJob: vi.fn(),
    jobEvents: vi.fn(),
    exportProfile: vi.fn(), importProfile: vi.fn(), llmConfig: vi.fn(), writeLlmConfig: vi.fn(), checkLlm: vi.fn(), offerHistory: vi.fn(), llmRuntime: vi.fn(), llmRuntimeAction: vi.fn(), shutdown: vi.fn(async () => ({ ok: true as const })),
    ...overrides,
  };
}
