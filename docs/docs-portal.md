...
6. **Nombre del repositorio en GitHub** (ruta base de Pages, `repository` en `package.json`, enlaces del CHANGELOG): ¿`lucasnunzi/chameleon-cv`, como en el ejemplo de T-7.3?
