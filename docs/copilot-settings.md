...
| **Estado** | PROPUESTA v1 (2026-08-30) **APROBADA en su totalidad** por el Director de Ingeniería y Producto el 2026-08-30 (diez decisiones de §10); S1 y S2 entregados el 2026-08-30 (§11); decisión 3 tomada por el Director el 2026-08-30 con el informe del *spike*: **solo Groq** (`docs/copilot-providers.md`) |
