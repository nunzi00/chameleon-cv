...
Cuatro recorridos guiados, de principio a fin, sobre un espacio de trabajo real. Cada uno empieza en un directorio vacío y no necesita nada que no traiga `cv`, salvo donde se indica (Typst para los PDF de calidad editorial; un modelo local para el co-piloto).
