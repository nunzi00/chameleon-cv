...
Descarga de [la página de *Releases*](https://github.com/nunzi00/chameleon-cv/releases) el archivo `chameleon-cv-<versión>-linux-x64.tar.gz` y su `.sha256` (Linux x86-64 con glibc ≥ 2.28; no necesita Node), verifica y extrae:
